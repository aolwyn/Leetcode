...
<p><strong>P.S. - would check out the README in the Java folder if you'd like a recap on data structures + some algorithms. There is also visualizations and graphics in that file. This is also a personal repository and has nothing to do with being a TA. <u>don't throw me under the bus</u> 😎.</strong></p>
